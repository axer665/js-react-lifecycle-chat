...
Backend вы можете взять готовый из каталога [репозитория](https://github.com/axer665/js-react-lifecycle-chat-server) (https://github.com/axer665/js-react-lifecycle-chat-server).
